...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Jalit Shop</title> 
	<meta name="description" content="jaket kulit alami & sentesis"/>
	<meta name="keywords" content="jaket kulit alami & sentesis" />
	<!-- end: Meta -->
...
<body>
	...
	<div id="wrapper">
    	...
    	<div class="container">
      		...
      		<div class="hero-unit">
        		<p>
				Jalit Shop merupakan toko online penjualan jacket kulit Alami Dan Sentesis             </p>
		...
		<!--	<div class="clients-carousel">
			...
			<div class="row">
				...
				<div class="icons-box-vert-container">
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Kami memberikan kualitas terbaik dalam penjualan jaket kulit alami & Sentesis, Karena menurut kami kepuasan pelanggan adalah tujuan utama kami.
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<!-- start: Icon Box Start --><!-- end: Icon Box -->
